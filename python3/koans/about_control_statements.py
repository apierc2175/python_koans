...
class AboutControlStatements(Koan):
    ...
    def test_for_statement_with_tuples(self):
        ...
        self.assertRegex(result[2], "'   Answer: '")

        self.assertNotRegex(result[0], "Contestant: 'Robin' Answer: 'Blue! I mean Green'")
        self.assertNotRegex(result[1], knight)
        self.assertNotRegex(result[3], 'Blue! I mean Green')
